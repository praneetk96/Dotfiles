...
from libqtile.config import Key, Screen, Group, Drag, Click, Match, KeyChord
            ...
            [
              ...
              widget.TextBox(
                ...
                widget.CheckUpdates(
                       ...
                       foreground = colors[2],
                       mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn(terminal + ' -e dnf check-update | wc -l')},
                       # custom_command = terminal + "dnf check-update | wc -l",
                       background = colors[4]
                       ),
                widget.TextBox(
                       text = "\uE0B2",

...
Plugin 'ryanoasis/vim-devicons'			" Nerd font is required to work properly
...
highlight SpellLocal cterm=Underline cterm=None
" }}}
...
noremap <leader>st :sp<Space>\|<Space>terminal<CR>
noremap <leader>vt :vs<Space>\|<Space>terminal<CR>
...
" Enable and disbale auto comment
